...
export codes="/home/shengjie/codes"
alias codes="cd $codes"
export linux='/home/shengjie/Documents/linuxLearning'
...
proxy()
{
    if [ -z "$1"  ]; then
        ...
        echo "  - for open proxy"
        echo "t - for open proxy and test it"
        echo "d - for close proxy"
    fi
}
